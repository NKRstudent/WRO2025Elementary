...
def mission1():
    ...
    run_front_claw(500, -164)
    robot_straight(FULL_SPEED, 155)
    run_front_claw(500, 90)
    robot_turn(FULL_SPEED, 87)
    calibration_with_wall(110)
    #robot_turn(200,-15)
    robot_straight(300, 1890) #Kyle fixed 
